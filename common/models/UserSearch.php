...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'first_name', 'last_name', 'company', 'api_key', 'api_secret', 'facebook_id', 'google_id', 'email_confirm_token', 'ip_address'], 'safe'],
        ];
    }
